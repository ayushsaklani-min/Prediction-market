...
export function useMarkets() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      // In production, fetch from The Graph subgraph or contract events
      console.log('No markets created yet. Create your first market!');
      return [];
    },
...
export function useMarketsByCategory(category: number) {
  ...
  return useQuery({
    queryKey: ['markets-by-category', category, markets],
    queryFn: async () => {
      if (!markets) return [];
